class AppImageAsset {
  ...
  static const String logo = "$rootImages/icon1.png";
  static const String onBoardingImageOne = "$rootImages/icon1_1.png";
  static const String onBoardingImageTwo = "$rootImages/icon2.png";
  static const String onBoardingImageThree = "$rootImages/icon5.png";
  static const String logInImage = "$rootImages/icon1.png";
  static const String cardImage = "$rootImages/rug1.jpg";
  ...
  static const String loading = "$rootLottie/YogaCarpet.json";
  ...
  static const String animationLoading = "$rootLottie/AnimationLoading.json";
